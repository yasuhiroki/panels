...
class QuestionAnswersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create question_answer" do
    assert_difference("QuestionAnswer.count") do
      post question_answers_url, params: { question_answer: { answer_id: @question_answer.answer_id, question_id: @question_answer.question_id } }
    end
  ...
  test "should update question_answer" do
    patch question_answer_url(@question_answer), params: { question_answer: { answer_id: @question_answer.answer_id, question_id: @question_answer.question_id } }
